...
# load input image
# load the appropriate ArUco dictionary
# perform ArUco marker detection on input image
...
if ARUCO_DICT.get(args['type'], None) is None:
    print('[INFO] {} ArUco Tag not found'.format(
        args['type']))
    sys.exit(0)


# load appropriate aruco dictionary
...
print('[INFO] Found {} markers with {} ids. {} were rejected'.format(
	len(corners), len(ids), len(rejected)
))
